...
#Funcion objetivo
model.Minimize( 45*x11 + 22*x12 + 30*x13 + 65*x14 + 15*x15 + 180*x21 + 163*x22 + 85*x23 + 148*x24 + 68*x25 + 21*x31 + 17*x32 + 193*x33 + 59*x34 + 65*x35 + 18*x41 + 83*x42 + 16*x43 + 70*x44 + 115*x45 + 97*x51 + 75*x52 + 20*x53 + 70*x54 + 71*x55)
